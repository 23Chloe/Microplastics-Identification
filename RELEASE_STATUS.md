...
| YOLOv7 / x / E6E | Verified replacement package | Archive-backed | Yes after dependencies and data are supplied; weights are published | No recovered run-level console log beyond the supplied package |
