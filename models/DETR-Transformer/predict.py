...
def get_args_parser():
    ...
    parser.add_argument('--output_dir', default='data/output/run',
                        help='path where to save, empty for no saving')
    parser.add_argument('--device', default='cuda',
                        help='device to use for training / testing')
    parser.add_argument('--seed', default=42, type=int)
    parser.add_argument('--resume', default='data/output/checkpoint0199.pth', help='resume from checkpoint')
...
def main(args):
    ...
    for image_item in image_file_path:
        ...
        image_path = os.path.join("data/coco/test",image_item)
